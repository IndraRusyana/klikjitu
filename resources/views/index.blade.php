...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--    Favicons-->
    <!-- ===============================================-->
    <link rel="apple-touch-icon" sizes="180x180" href="{{asset('asset/theme/boldo/img/favicons/apple-touch-icon.png')}}">
    <link rel="icon" type="image/png" sizes="32x32" href="{{asset('asset/theme/boldo/img/favicons/favicon-32x32.png')}}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset('asset/theme/boldo/img/favicons/favicon-16x16.png')}}">
    ...
    <link href="{{asset('asset/theme/boldo/css/prism.css')}}" rel="stylesheet">
    <link href="{{asset('asset/theme/boldo/css/swiper-bundle.min.css')}}" rel="stylesheet">
    <link href="{{asset('asset/theme/boldo/css/theme.css')}}" rel="stylesheet" />
  ...
  <body>
    ...
    <main class="main" id="top">
      <nav class="navbar py-1 navbar-expand-lg navbar-dark" style="background-color: black">
        <div class="container"><a class="navbar-brand fs-4 fw-bold" href="index.html">KlikJitu.</a>
      ...
      <div class="" style="background-color: black">
        {{-- <img class="img-fluid position-absolute end-0" src="asset/theme/boldo/img/hero/hero-bg.png" alt="" /> --}}
          ...
          <div class="container">
            <div class="row align-items-center py-lg-8 py-6">
              <div class="col-lg-6 text-center text-lg-start">
                <h1 class="text-white fs-5 fs-xl-6">Ciptakan Website Profesional dan Undangan Digital dengan KlikJitu.</h1>
                <p class="text-white py-lg-3 py-2">Pembuatan Website dan Undangan Digital yang Menarik, Solusi Debugging Efektif, dan Hosting Aman untuk Bisnis Anda.</p>
                <div class="d-sm-flex align-items-center gap-3">
                  <button class="btn btn-success text-black mb-3 w-75">Make a contact</button>
                  
                </div>
              </div>
              {{-- <div class="col-lg-6 text-center text-lg-end mt-3 mt-lg-0">
                <img class="img-fluid" src="asset/theme/boldo/img/hero/hero-graphics.png" alt="" />
              </div> --}}
            </div>
            {{-- <div class="swiper">
              <div class="swiper-container swiper-shadow swiper-theme" data-swiper='{"slidesPerView":2,"breakpoints":{"640":{"slidesPerView":2,"spaceBetween":20},"768":{"slidesPerView":4,"spaceBetween":40},"992":{"slidesPerView":5,"spaceBetween":40},"1024":{"slidesPerView":4,"spaceBetween":50},"1025":{"slidesPerView":6,"spaceBetween":50}},"spaceBetween":10,"grabCursor":true,"pagination":{"el":".swiper-pagination","clickable":true},"loop":true,"freeMode":true,"autoplay":{"delay":2500,"disableOnInteraction":false}}'>
                <div class="swiper-wrapper">
                  <div class="swiper-slide text-center"><img src="asset/theme/boldo/img/logos/boldo.png" alt="" /></div>
                  <div class="swiper-slide text-center"><img src="asset/theme/boldo/img/logos/presto.png" alt="" /></div>
                  <div class="swiper-slide text-center"><img src="asset/theme/boldo/img/logos/boldo.png" alt="" /></div>
                  <div class="swiper-slide text-center"><img src="asset/theme/boldo/img/logos/presto.png" alt="" /></div>
                  <div class="swiper-slide text-center"><img src="asset/theme/boldo/img/logos/boldo.png" alt="" /></div>
                  <div class="swiper-slide text-center"><img src="asset/theme/boldo/img/logos/presto.png" alt="" /></div>
      ...
      <section>
        ...
        <div class="container">
          ...
          <div class="row gx-xl-7 mt-5">
            <div class="col-md-6 mb-6 mb-md-0 text-center text-md-start"><img class="w-100 w-md-100" src="https://picsum.photos/id/7/200/100" alt="" />
              <h4 class="mt-3 my-1">Pembuatan Website</h4>
              <p class="fs-1 mb-0">Desain responsif dan fungsional yang disesuaikan dengan kebutuhan bisnis Anda.</p><a class="text-dark fs-1 pb-2 fw-bold border-black border-bottom text-decoration-none" href="#">Explore page<i class="fa-solid fa-arrow-right ms-2"></i></a>
            </div>
            <div class="col-md-6 mb-6 mb-md-0 text-center text-md-start"><img class="w-100 w-md-100" src="https://picsum.photos/id/10/200/100" alt="" />
              <h4 class="mt-3 my-1">Undangan Digital</h4>
              <p class="fs-1 mb-0">Undangan kreatif dan interaktif untuk acara spesial Anda.</p><a class="text-dark fs-1 pb-2 fw-bold border-black border-bottom text-decoration-none" href="#">Explore page<i class="fa-solid fa-arrow-right ms-2"></i></a>
            </div>
          </div>
        </div>
        <!-- end of .container-->
      ...
      <section style="background-color: black">
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-6 text-center text-lg-start"><img class="img-fluid" src="asset/theme/boldo/img/offer/1.png" alt="" /></div>
            <div class="col-lg-6">
              <h1 class="fs-xl-5 fs-lg-4 fs-3 text-white">We connect our customers with the best, and help them keep up-and stay open.</h1>
              <ul class="list-unstyled my-xl-5 my-3">
                <li class="text-white fs-2 my-4 d-flex align-items-center gap-3 text-black"><i class="fa-solid fa-circle-check fs-4 text-dark"></i><span>We connect our customers with the best.</span></li>
                <li class="text-white fs-2 my-4 d-flex align-items-center gap-3 text-black"><i class="fa-solid fa-circle-check fs-4 text-dark"></i><span>Advisor success customer launch party.</span></li>
                <li class="text-white fs-2 my-4 d-flex align-items-center gap-3 text-black"><i class="fa-solid fa-circle-check fs-4 text-dark"></i><span>Business-to-consumer long tail.</span></li>
              </ul>
      ...
      <section class="pt-8 pt-lg-0">
        ...
        <div class="container">
          <div class="d-flex flex-column-reverse flex-lg-row">
            ...
            <div class="col-lg-6 text-center text-lg-end"><img class="img-fluid" src="asset/theme/boldo/img/offer/2.png" alt="" /></div>
          </div>
        </div>
        <!-- end of .container-->
              ...
              <div class="swiper-wrapper">
                <div class="swiper-slide bg-white p-5 rounded-3 h-auto">
                  <div class="d-flex flex-column justify-content-between h-100">
                    ...
                    <div class="d-flex align-items-center gap-3 mt-5"><img src="asset/theme/boldo/img/review/1.png" alt="" />
                ...
                <div class="swiper-slide bg-white p-5 rounded-3 h-auto">
                  <div class="d-flex flex-column justify-content-between h-100">
                    ...
                    <div class="d-flex align-items-center gap-3 mt-5"><img src="asset/theme/boldo/img/review/2.png" alt="" />
                      <div class="text-black">
                ...
                <div class="swiper-slide bg-white p-5 rounded-3 h-auto">
                  <div class="d-flex flex-column justify-content-between h-100">
                    ...
                    <div class="d-flex align-items-center gap-3 mt-5"><img src="asset/theme/boldo/img/review/3.png" alt="" />
                      <div class="text-black">
      ...
      <section>
        ...
        <div class="container"><img class="img-fluid" src="asset/theme/boldo/img/offer/3.png" alt="" />
        ...
        <div class="container">
          ...
          <div class="row mt-7 gx-xl-7">
            <div class="col-md-4 text-center text-md-start h-auto mb-5">
              <div class="d-flex justify-content-between flex-column h-100"><a href="#"><img class="w-75 w-md-100 rounded-2" src="asset/theme/boldo/img/blog/1.png" alt="" /></a>
                ...
                <div class="d-flex align-items-center justify-content-center justify-content-md-start gap-3"><img class="img-fluid" src="asset/theme/boldo/img/blog/profile1.png" alt="" /><a href="#">
                    <p class="mb-0 text-gray">Chandler Bing</p>
                  </a></div>
              </div>
            </div>
            <div class="col-md-4 text-center text-md-start h-auto mb-5">
              <div class="d-flex justify-content-between flex-column h-100"><a href="#"><img class="w-75 w-md-100 rounded-2" src="asset/theme/boldo/img/blog/2.png" alt="" /></a>
                <div class="d-flex align-items-center justify-content-center justify-content-md-start gap-2 mt-3"><a href="#">
                    <p class="fw-bold mb-0 text-black">Category</p>
                  </a>
                  <p class="mb-0">November 22, 2021</p>
                ...
                <div class="d-flex align-items-center justify-content-center justify-content-md-start gap-3"><img class="img-fluid" src="asset/theme/boldo/img/blog/profile2.png" alt="" /><a href="#">
                    <p class="mb-0 text-gray">Rachel Green</p>
                  </a></div>
              </div>
            </div>
            <div class="col-md-4 text-center text-md-start h-auto mb-5">
              <div class="d-flex justify-content-between flex-column h-100"><a href="#"><img class="w-75 w-md-100 rounded-2" src="asset/theme/boldo/img/blog/3.png" alt="" /></a>
                <div class="d-flex align-items-center justify-content-center justify-content-md-start gap-2 mt-3"><a href="#">
                    <p class="fw-bold mb-0 text-black">Category</p>
                  </a>
                  <p class="mb-0">November 22, 2021</p>
                ...
                <div class="d-flex align-items-center justify-content-center justify-content-md-start gap-3"><img class="img-fluid" src="asset/theme/boldo/img/blog/profile3.png" alt="" /><a href="#">
    ...
    <section>
      ...
      <div class="container bg-dark overflow-hidden rounded-1">
        <div class="bg-holder" style="background-image:url(asset/theme/boldo/img/promo/promo-bg.png);">
        </div>
        <!--/.bg-holder-->
    ...
    <section class="pt-0">
      ...
      <div class="container">
        <div class="row justify-content-between">
          <div class="col-lg-6 col-sm-12"><a href="index.html"><img class="img-fluid mt-5 mb-4" src="asset/theme/boldo/img/black-logo.png" alt="" /></a>
    ...
    <!--    JavaScripts-->
    <!-- ===============================================-->
    <script src="{{asset('asset/theme/boldo/js/popper/popper.min.js')}}"></script>
    <script src="{{asset('asset/theme/boldo/js/bootstrap/bootstrap.min.js')}}"></script>
    <script src="{{asset('asset/theme/boldo/js/anchorjs/anchor.min.js')}}"></script>
    <script src="{{asset('asset/theme/boldo/js/is/is.min.js')}}"></script>
    <script src="{{asset('asset/theme/boldo/js/fontawesome/all.min.js')}}"></script>
    <script src="{{asset('asset/theme/boldo/js/lodash/lodash.min.js')}}"></script>
    <script src="https://polyfill.io/v3/polyfill.min.js?features=window.scroll"></script>
    <script src="{{asset('asset/theme/boldo/js/prism/prism.js')}}"></script>
    <script src="{{asset('asset/theme/boldo/js/swiper/swiper-bundle.min.js')}}"></script>
    <script src="{{asset('asset/theme/boldo/js/theme.js')}}"></script>
